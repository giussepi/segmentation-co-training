# -*- coding: utf-8 -*-
""" nns/models/unet_3plus_intra_da """
...
class UNet_3Plus_Intra_DA(UNet_3Plus, InitMixin):
    ...
    def __init__(self, da_block_cls: BaseDisagreementAttentionBlock = ThresholdedDisagreementAttentionBlock,
        ...
        # disagreement attention between h4 and hd4
        self.intra_da_hd4 = DAConvBlock(
            # attention to skip_connection
            da_block_cls(self.filters[3], self.UpChannels, **self.da_block_config),
            self.filters[3]+self.UpChannels,
            # atttention to X
            # da_block_cls(self.UpChannels, self.filters[3], **self.da_block_config), self.filters[3]+self.UpChannels,
            self.UpChannels
        )
        # disagreement attention between h3 and hd3
        ...
        # disagreement attention between h2 and hd2
    ...
    def forward_8(self, x: dict):
        ...
        x['intra_da_hd4'] = self.intra_da_hd4(x['hd4'], x['h4'])
        ...
        x['hd4_UT_hd3'] = self.hd4_UT_hd3_relu(self.hd4_UT_hd3_bn(self.hd4_UT_hd3_conv(
            self.hd4_UT_hd3(x['intra_da_hd4']))))
    ...
    def forward_9(self, x: dict):
        ...
        x['intra_da_hd3'] = self.intra_da_hd3(x['hd3'], x['h3'])
    ...
    def forward_10(self, x: dict):
        ...
        x['intra_da_hd2'] = self.intra_da_hd2(x['hd2'], x['h2'])
    ...
    def forward_11(self, x: dict):
        ...
        x['intra_da_hd1'] = self.intra_da_hd1(x['hd1'], x['h1'])
    ...
    def forward_12(self, x: dict):
        ...
        d1 = self.outconv1(x['intra_da_hd1'])  # d1->320*320*n_classes
