# -*- coding: utf-8 -*-
""" nns/models/layers/disagreement_attention/inter_class/mixed_merged_disagreement """
...
__all__ = ['MixedEmbeddedDisagreementAttentionBlock']


class MixedEmbeddedDisagreementAttentionBlock(BaseDisagreementAttentionBlock):
    r"""
    Calculates the Mixed embedded disaggrement attention from activations2 (belonging to model 2) towards
    ...
    #     act1_with_attention = 2*wact2 + torch.abs(wact2 - wact1)
    ...
    def forward(self, act1: torch.Tensor, act2: torch.Tensor):
        ...
        delta_act2 = 2*wact2 + torch.abs(wact2 - wact1)
