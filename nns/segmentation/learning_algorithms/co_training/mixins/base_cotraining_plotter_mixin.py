# -*- coding: utf-8 -*-
""" nns/segmentation/learning_algorithms/co_training/mixins/base_cotraining_plotter_mixin """
...
class BaseCotrainingPlotterMixin(TorchMetricsMixin):
    """
    Contains methods to plot data from class CoTraining

    Usage:
        class MyCotrainingPlotterMixin(BaseCotrainingPlotterMixin, ...):
            ...
    """
