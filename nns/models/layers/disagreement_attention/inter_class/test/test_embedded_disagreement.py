# -*- coding: utf-8 -*-
""" nns/models/layers/disagreement_attention/inter_class/test/test_embedded_disagreement """
...
from nns.models.layers.disagreement_attention.inter_class import EmbeddedDisagreementAttentionBlock
