...
from nns.models import Deeplabv3plus, UNet_3Plus_DA, UNet_3Plus_DA_Train, UNet_3Plus_DA2, \
    ...
    MultiAttentionBlock, UNet3D, XGridAttentionUNet, XAttentionUNet_ADSV
...
def main():
    ...
    # model6 = dict(
    # model6 = ModelMGR(
    #     model=XAttentionUNet_ADSV,  # XAttentionUNet,  # UNet_Att_DSV,  # UNet2D,  # UNet_Grid_Attention,  # AttentionUNet2, # UNet_3Plus,
