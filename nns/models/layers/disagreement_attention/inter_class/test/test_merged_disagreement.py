# -*- coding: utf-8 -*-
""" nns/models/layers/disagreement_attention/inter_class/test/test_merged_disagreement """

import unittest

import torch

from nns.models.layers.disagreement_attention.inter_class import MergedDisagreementAttentionBlock
