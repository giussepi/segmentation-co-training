# -*- coding: utf-8 -*-
""" nns/models/layers/disagreement_attention/inter_model/test/test_gating_signal """

import unittest

import torch

from nns.models.layers.disagreement_attention.inter_model import AttentionBlock
