...
from nns.models import Deeplabv3plus, UNet_3Plus_DA, UNet_3Plus_DA_Train, UNet_3Plus_DA2, \
    ...
    MultiAttentionBlock, UNet3D, XGridAttentionUNet, XAttentionAENet
...
def main():
    ...
    # model6 = dict(
    # model6 = ModelMGR(
    #     model=XAttentionAENet,  # XAttentionUNet,  # UNet_Att_DSV,  # UNet2D,  # UNet_Grid_Attention,  # AttentionUNet2, # UNet_3Plus,
    ...
    model7 = ModelMGR(
        model=XAttentionAENet,  # UNet_Att_DSV,  # UNet_Grid_Attention,,  # XAttentionUNet,  # UNet3D,
        # UNet3D
