...
class UNet_3Plus_DA2(UNet_3Plus_DA):
    ...
    def forward_8(self, x: dict, skip_connection: torch.Tensor, metric2: float):
        ...
        x['hd4A'] = self.da_hd4(x['hd4'], skip_connection, disable_attention=metric2 <= self.da_threshold)
    ...
    def forward_9(self, x: dict, skip_connection: torch.Tensor, metric2: float):
        ...
        x['hd3A'] = self.da_hd3(x['hd3'], skip_connection, disable_attention=metric2 <= self.da_threshold)
    ...
    def forward_10(self, x: dict, skip_connection: torch.Tensor, metric2: float):
        ...
        x['hd2A'] = self.da_hd2(x['hd2'], skip_connection, disable_attention=metric2 <= self.da_threshold)
    ...
    def forward_11(self, x: dict, skip_connection: torch.Tensor, metric2: float):
        ...
        # x['hd1A'] = self.da_hd1(x['hd1'], skip_connection, disable_attention=metric2 <= self.da_threshold)
