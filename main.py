...
from nns.models import Deeplabv3plus, UNet_3Plus_DA, UNet_3Plus_DA_Train, UNet_3Plus_DA2, \
    ...
    MultiAttentionBlock, UNet3D, XGridAttentionUNet
...
def main():
    ...
    # model6 = dict(
    # model6 = ModelMGR(
    #     model=XGridAttentionUNet,  # XAttentionUNet,  # UNet_Att_DSV,  # UNet2D,  # UNet_Grid_Attention,  # AttentionUNet2, # UNet_3Plus,
    #     model_kwargs=dict(da_block_cls=intra_model.EmbeddedDABlock,
